            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-md-6">
                    <div class="card info-card sales-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">All Assets <span>| Today</span></h5>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6>{{ $totalItems }}</h6>
                                    @can('assets-view')
                                    <a href="{{route('items.index')}}">View Assets</a>
                                    @endcan
                ...
                <div class="col-xxl-4 col-xl-12">
                    ...
                    <div class="card info-card customers-card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Dispatch <span>| This Year</span></h5>
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6>{{$dispatch_requests}}</h6>
                                    @can('dispatch-requests-view')
                                    <a href="{{route('items.index')}}">View Requests</a>
                                    @endcan
                    ...
                    <div class="card top-selling overflow-auto">
                        ...
                        <div class="card-body pb-0">
                            ...
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><a href="#"><img src="{{ url('')}}/assets/img/product-1.jpg"
                                                    alt=""></a></th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img src="{{ url('')}}/assets/img/product-2.jpg"
                                                    alt=""></a></th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img src="{{ url('')}}/assets/img/product-3.jpg"
                                                    alt=""></a></th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img src="{{ url('')}}/assets/img/product-4.jpg"
                                                    alt=""></a></th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img src="{{ url('')}}/assets/img/product-5.jpg"
                                                    alt=""></a></th>
